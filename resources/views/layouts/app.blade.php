...
<head>
    ...
    <title>IgnasBernotas Laravel Crud</title>
...
<nav class="navbar navbar-default navbar-ststic-top">
    <div class="container">
        <div class="navbar-header">
            <a class="navbar-brand" href="{{route('post.index')}}">IgnasBernotasCodeLog</a>
        </div>
    </div>
</nav>
<div class="container">
...
<script type="text/javascript">
    ...
    $(document).on('click', '.edit-modal', function() {
        $('#footer_action_button').text(" Update Posts");
        $('#footer_action_button').addClass('glyphicon-check');
        $('#footer_action_button').removeClass('glyphicon-trash');
        $('.actionBtn').addClass('btn-success');
        $('.actionBtn').removeClass('btn-danger');
        $('.actionBtn').addClass('edit');
        $('.modal-title').text('Posts Edit');
        $('.deleteContent').hide();
        $('.form-horizontal').show();
