            ...
            <table class="table table-bordered" id="table">
                <tr>
                    ...
                    <th class="text-center" width="150px">
                        <h href="#" class="create-modal btn btn-success btn-sm">
                ...
                @foreach ($post as $key => $value)
                    <tr class="post{{$value->id}}">
                        ...
                        <td>
                            <a href="#" class="show-modal btn bnt-info btn-sm" data-id="{{$value->id}}" data-title="{{$value->title}}" data-body="{{$value->body}}">
                                <i class="fa fa-eye"></i>
                            </a>
    ...
    {{-- Modal Form Edit and Delete Posts --}}
